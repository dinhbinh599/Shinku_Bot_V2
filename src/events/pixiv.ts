...
import { PixivIllustListEmbeds } from '../embed/pixiv/pixivEmbed.js';
import { IPixivIllustResponse } from '../types/pixiv.js';
import { editOrReplyThenDelete } from '../utils/shortFunc/editOrReplyThenDelete.js';
